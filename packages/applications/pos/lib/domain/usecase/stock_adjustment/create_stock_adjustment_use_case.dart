...
class CreateStockAdjustmentUseCase
    extends BaseUseCaseParam<CreateStockAdjustmentParam, StockAdjustment> {
  final StockAdjustmentRepository stockAdjustmentRepo;

  CreateStockAdjustmentUseCase({required this.stockAdjustmentRepo});

  @override
  Future<StockAdjustment> call(CreateStockAdjustmentParam param) =>
      stockAdjustmentRepo.createStockAdjustment(param);
}
